...
partition = input_file[446+16:462+16]
partition_type = partition[4:5]
print 'partition_type', binascii.b2a_hex(partition_type), 'in hex'
partition_size = partition[12:16]
print 'partition_size', convert_to_little_endian(binascii.b2a_hex(partition_size)), 'in hex'
...
partition = input_file[446+32:462+32]
partition_type = partition[4:5]
print 'partition_type', binascii.b2a_hex(partition_type), 'in hex'
partition_size = partition[12:16]
print 'partition_size', convert_to_little_endian(binascii.b2a_hex(partition_size)), 'in hex'
...
partition = input_file[446+48:462+48]
partition_type = partition[4:5]
print 'partition_type', binascii.b2a_hex(partition_type), 'in hex'
partition_size = partition[12:16]
print 'partition_size', convert_to_little_endian(binascii.b2a_hex(partition_size)), 'in hex'
